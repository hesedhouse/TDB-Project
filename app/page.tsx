    ...
    <main className="min-h-screen bg-midnight-black pt-2 safe-top flex flex-col">
      {currentView === 'home' && (
        <>
          ...
          <footer className="flex-shrink-0 w-full bg-midnight-black text-slate-500 p-4 text-center">
            <div className="max-w-2xl mx-auto flex flex-col items-center space-y-0.5 text-[11px]">
              <p><strong className="text-slate-500">상호</strong> 헤세드하우스</p>
              <p><strong className="text-slate-500">대표자</strong> 이현우</p>
              <p><strong className="text-slate-500">사업자등록번호</strong> 2019-고양일산서-</p>
              <p><strong className="text-slate-500">통신판매업신고번호</strong> 제 202X-서울XX-0000호</p>
              <p><strong className="text-slate-500">영업소 소재지</strong> 경기도 고양시 일산서구 덕이로 24</p>
              <p><strong className="text-slate-500">이메일</strong> support@poppinapps.com</p>
              <p><strong className="text-slate-500">전화번호</strong> 031-994-7740</p>
            </div>
          </footer>
        </>
      )}
